<?php
  ...
  * Slug: advizecraft/single-product
  * Inserter: no
  */
?>
...
<main class="wp-block-cover" style="margin-top:0;margin-bottom:0;min-height:232px"><span aria-hidden="true" class="wp-block-cover__background has-accent-background-color has-background-dim-100 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
<h2 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:500"> <?php echo esc_html__( 'Single Product', 'advizecraft' ); ?> </h2>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"25px","left":"25px"}}},"layout":{"inherit":true,"type":"constrained"}} -->
...
<h2 class="wp-block-heading"><?php echo esc_html__( 'Related Products', 'advizecraft' ); ?></h2>
<!-- /wp:heading -->
